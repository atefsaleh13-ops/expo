...
struct JavaScriptArrayTests {
  ...
  func `create array from JavaScript`() throws {
    let array = try runtime.eval("[1, 2, 3, 4, 5]").getObject().getArray()
    #expect(array.size == 5)
  }

  @Test
  func `access empty array`() throws {
    let array = try runtime.eval("[]").getObject().getArray()
    #expect(array.size == 0)
  }

  @Test
  func `array with mixed types`() throws {
    let array = try runtime.eval("[1, 'hello', true, null, { key: 'value' }]").getObject().getArray()
    #expect(array.size == 5)
  ...
  func `size of array with elements`() throws {
    let array = try runtime.eval("[10, 20, 30]").getObject().getArray()
    #expect(array.size == 3)
  }

  @Test
  func `size of single element array`() throws {
    let array = try runtime.eval("[42]").getObject().getArray()
    #expect(array.size == 1)
  }

  @Test
  func `size of large array`() throws {
    let array = try runtime.eval("Array(1000).fill(0)").getObject().getArray()
  ...
  func `get value at valid index`() throws {
    let array = try runtime.eval("['a', 'b', 'c']").getObject().getArray()
  ...
  func `get first element`() throws {
    let array = try runtime.eval("[100, 200, 300]").getObject().getArray()
  ...
  func `get value at negative index throws`() throws {
    let array = try runtime.eval("[1, 2, 3]").getObject().getArray()
  ...
  func `subscript access throws at out of range index`() throws {
    let array = try runtime.eval("['a', 'b']").getObject().getArray()
  ...
  func `map to strings`() throws {
    let array = try runtime.eval("['hello', 'world', 'test']").getObject().getArray()
  ...
  func `map to doubles`() throws {
    let array = try runtime.eval("[1.5, 2.5, 3.5]").getObject().getArray()
  ...
  func `map to booleans`() throws {
    let array = try runtime.eval("[true, false, true]").getObject().getArray()
  ...
  func `map array of objects`() throws {
    let array = try runtime.eval("[{name:'Alice',age:30},{name:'Bob',age:25}]").getObject().getArray()
  ...
  func `map throws when transform throws`() throws {
    let array = try runtime.eval("[1, 'not a number', 3]").getObject().getArray()
  ...
  func `array as value is array type`() throws {
    let array = try runtime.eval("['a', 'b', 'c']").getObject().getArray()
    let value = array.asValue()
    let backToArray = value.getObject().getArray()
  ...
  func `iterate using size`() throws {
    let array = try runtime.eval("[10, 20, 30, 40]").getObject().getArray()
    var sum = 0
  ...
  func `iterate and collect values`() throws {
    let array = try runtime.eval("['a', 'b', 'c', 'd']").getObject().getArray()
    var values: [String] = []
  ...
  func `array with undefined elements`() throws {
    let array = try runtime.eval("[undefined, undefined, undefined]").getObject().getArray()
    #expect(array.size == 3)
  ...
  func `array with null elements`() throws {
    let array = try runtime.eval("[null, null]").getObject().getArray()
    #expect(array.size == 2)
  ...
  func `nested arrays`() throws {
    let array = try runtime.eval("[[1, 2], [3, 4], [5, 6]]").getObject().getArray()
    #expect(array.size == 3)

    let firstNested = try array[0].getObject().getArray()
  ...
  func `array from Array.from()`() throws {
    let array = try runtime.eval("Array.from([1, 2, 3])").getObject().getArray()
    #expect(array.size == 3)
  ...
  func `array from spread operator`() throws {
    let array = try runtime.eval("[...[1, 2], ...[3, 4]]").getObject().getArray()
    #expect(array.size == 4)
  ...
  func `access all elements in large array`() throws {
    let array = try runtime.eval("Array(100).fill(42)").getObject().getArray()
  ...
  func `map large array`() throws {
    let array = try runtime.eval("Array(100).fill(1)").getObject().getArray()
    let result = array.map { $0.getInt() }
